...
![PHP过滤器.png](assets/1698896037-7dc19d484e9018f7e80d02af6431f5a8.png)
...
![CT绕过截图.png](assets/1698896037-0e084a4b1356fad32421794598c545aa.png)
...
![VT绕过.png](assets/1698896037-d43d270ccf2a094a50fc57e72cacfb78.png)
...
![WebShell基本构造.png](assets/1698896037-373cd97f7eebefe1d43a83ff5b4e6401.png)
...
![whoami转十六进制.png](assets/1698896037-b1347ee821e8728377529197c7f2fbbe.png)
...
意思就是，从HTTP请求头获取名为 "HTTP\_X\_CSRF\_TOKEN" 的值，并进行Base64解密再讲值重新赋给 `$v`
...
-   `$v` 参数：从HTTP请求头获取名为 "HTTP\_X\_CSRF\_TOKEN" 的值，并进行Base64解密再讲值重新赋给 `$v`
